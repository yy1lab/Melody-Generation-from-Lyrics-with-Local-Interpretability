...
def main():
    ...
    if not IS_GAN:
        ...
        # adv_train_ckpt.restore('../../checkpoints/adv_train_c_hybrid_gan/ckpt-85').expect_partial()
    ...
    save_obj(word_lyrics, '../../results/c_hybrid_gan//generated/word_lyrics')
    save_obj(syll_lyrics, '../../results/c_hybrid_gan//generated/syll_lyrics')
    save_obj(meta[:, :song_length, :], '../../results/c_hybrid_gan//generated/x_test')
    save_obj(lyrics[:, :song_length, :], '../../results/c_hybrid_gan//generated/lyrics')
    save_obj(attr_out[:, :song_length, :], '../../results/c_hybrid_gan//generated/attr_out')
    save_obj(out_pro[0].numpy(), '../../results/c_hybrid_gan//generated/y_out')
