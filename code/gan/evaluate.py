"""
Script to evaluate the GAN model on test data.
...
def main():
    ...
    #
    # pickle.dump(y_test_gen_attr, open('../../results/gan/generated/c_hybrid_mle_y_test_gen_attr.pkl', 'wb'),
    #             pickle.HIGHEST_PROTOCOL)
    # np.save('../../results/gan/generated/mle_test_gen_songs.npy', test_gen_songs)
    # pickle.dump(test_gen_mean_stats, open('../../results/gan/generated/c_hybrid_mle_test_mean_stats.pkl', 'wb'),
    #             pickle.HIGHEST_PROTOCOL)
    ...
    #adv_train_ckpt.restore('../../checkpoints/adv_train_gan/ckpt-120').expect_partial()
    ...
    pickle.dump(y_test_gen_attr, open('../../results/gan/generated/gan_y_test_gen_attr.pkl', 'wb'),
                pickle.HIGHEST_PROTOCOL)
    np.save('../../results/gan/generated/gan_test_gen_songs.npy', test_gen_songs)
    pickle.dump(test_gen_mean_stats, open('../../results/gan/generated/gan_test_mean_stats.pkl', 'wb'),
                pickle.HIGHEST_PROTOCOL)
